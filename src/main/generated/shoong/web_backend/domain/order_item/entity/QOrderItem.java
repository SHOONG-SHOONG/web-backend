...
public class QOrderItem extends EntityPathBase<OrderItem> {
    ...
    private static final long serialVersionUID = 2043212315L;
    ...
    public final shoong.web_backend.domain.orders.entity.QOrders order;
    ...
    public QOrderItem(Class<? extends OrderItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.order = inits.isInitialized("order") ? new shoong.web_backend.domain.orders.entity.QOrders(forProperty("order"), inits.get("order")) : null;
    }
